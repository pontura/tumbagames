...
{
    public static void TrackLevelComplete(GAProgressionStatus status, string progression1, string progression2)
    {
        GameAnalytics.NewProgressionEvent(status, progression1, progression2);
    }
    public static void TrackEvent(string eventName, float eventValue = 0)
    {
        if (eventValue > 0)
    ...
    public static void TrackError(GAErrorSeverity severity, string message)
    {
